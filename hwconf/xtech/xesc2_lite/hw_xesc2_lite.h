...
#ifndef HW_XESC2_LITE_CORE_H_
#define HW_XESC2_LITE_CORE_H_

bool drv_error(void);
void drv8376_reset_faults(void);


#define HW_NAME					"xESC2 Lite"
...
// TODO: Use a correct pin here.
#define HW_SPI_PORT_NSS			GPIOD
#define HW_SPI_PIN_NSS			2
...
#define HW_RESET_DRV_FAULTS()		drv8376_reset_faults()
...
// Setting limits
#define HW_LIM_CURRENT			-3.0, 3.0
#define HW_LIM_CURRENT_IN		-9.0, 9.0
#define HW_LIM_CURRENT_ABS		0.0, 15.0
#define HW_LIM_VIN				6.0, 55.0
#define HW_LIM_ERPM				-200e3, 200e3
#define HW_LIM_DUTY_MIN			0.0, 0.1
#define HW_LIM_DUTY_MAX			0.0, 0.99
#define HW_LIM_TEMP_FET			-40.0, 90.0
#define MCCONF_MAX_CURRENT_UNBALANCE (FAC_CURRENT * 1024)


#endif /* HW_XESC2_LITE_CORE_H_ */
